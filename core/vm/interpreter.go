...
const (
	InterpreterMode_EVM InterpreterMode = iota
	InterpreterMode_Substrate
	InterpreterMode_TAC
)

func (mode InterpreterMode) String() string {
	switch mode {
	case InterpreterMode_EVM:
		return "InterpreterMode_EVM"
	case InterpreterMode_Substrate:
		return "InterpreterMode_Substrate"
	case InterpreterMode_TAC:
		return "InterpreterMode_TAC"
	default:
		return fmt.Sprintf("InterpreterMode_Unknown_%d", int(mode))
	}
}
